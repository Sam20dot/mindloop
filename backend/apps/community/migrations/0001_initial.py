    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('achievement', 'Achievement'), ('cv_share', 'CV Share'), ('opportunity_share', 'Opportunity Share'), ('learning_update', 'Learning Update')], default='learning_update', max_length=30)),
